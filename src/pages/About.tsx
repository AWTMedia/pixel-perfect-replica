            ...
            <div className="relative px-6 md:px-12 py-14 md:py-16">
              <div className="grid md:grid-cols-2 gap-12 items-center">
                <motion.div initial="hidden" whileInView="show" viewport={{ once: true, amount: 0.3 }} variants={stagger}>
                  ...
                  <motion.h2 variants={fadeUp} className="mt-2 text-4xl md:text-5xl font-black text-white leading-tight">
                    The Attraction Engine
                  </motion.h2>
                  <motion.p variants={fadeUp} className="mt-4 text-white/80 text-lg leading-relaxed max-w-xl">
